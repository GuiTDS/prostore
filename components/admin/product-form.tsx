...
function ProductForm({ type, product, productId }: {
    type: 'Create' | 'Update';
    product?: Product;
    productId?: string;
}) {
    ...
    const formType = type === 'Create' ? insertProductSchema : updateProductSchema;
    ...
    const onSubmit: SubmitHandler<z.infer<typeof formType>> = async (values) => {
        // On create
        if (type === 'Create') {
                    ...
                    <FormField control={form.control}
                        ...
                        render={({ field }: { field: ControllerRenderProps<z.infer<typeof insertProductSchema>, 'stock'> }) => (
                            <FormItem className="w-full">
                                ...
                                <FormControl>
                                    <Input placeholder="Enter the stock" {...field} />
                                </FormControl>
                                <FormMessage />
                            </FormItem>
                        )}
